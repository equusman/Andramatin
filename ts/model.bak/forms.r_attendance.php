...
<body>
      <table class="list">
        ...
        <tr style="display: table-row;">
            <th align="left">Tanggal</th><th align="left">Name</th><th align="left">User ID</th><th align="left">Check In Time</th><th align="left">Check Out Time</th> 
        </tr>
		</thead>
		<tbody>
<?php		
	...
	<?php
		...
		foreach($attendance as $row)
		{
			...
			$emptydate = ($row['userid']!="") ? $row['name'] : "[- None -]";
			// $newid = $row['userid'];
			$newdate = $row['tanggal'];
			...
			echo "</td><td>".$emptydate."</td><td>".$row['userid']."</td><td>".$row['checkin']."</td><td>".$row['checkout']."</td> </tr>";
			$prevdate = $newdate;
			$gantinode = false;
		}
