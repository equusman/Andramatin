...
function getAttendance($data){
	...
	$enddate = isset($data['enddate']) && !empty($data['enddate'])? DateTime::createFromFormat('Y-m-d H:i:s', $data['enddate']." 01:00:00" )->format('Y-m-d H:i:s'):$currentmonth->format('Y-m-d H:i:s') ;
