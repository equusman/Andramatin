<?php
	...
	// get query strings
	$qs = '';
	if (isset($_POST['filter_holiday'])) {
		$qs = empty($qs)? 'filter_holiday='.$_POST['filter_holiday'] : '&filter_holiday='.$_POST['filter_holiday'];
	}
	if (isset($_POST['page'])) {
	...
	// }
			...
			$_response['redirect'] = HTTPS_SERVER.'forms/amts/holiday.php?'.$qs;
