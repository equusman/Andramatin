<?php
	...
	// get query strings
	$qs = '';
	if (isset($_POST['filter_setting'])) {
		$qs = empty($qs)? 'filter_setting='.$_POST['filter_setting'] : '&filter_setting='.$_POST['filter_setting'];
	}
	if (isset($_POST['page'])) {
	...
	// }
			...
			$_response['redirect'] = HTTPS_SERVER.'forms/admin/appsetting.php?'.$qs;
