                    ...
                    <script>
                        ...
                        $(function(){
                            table = $("#tasklisttable").tablecontrol({
                                ...
                                checkRow: true,
                                colModel: [
									{field: 'date', caption: 'Date', width: '100', sortable: true, cls: 'text-center', hcls: ""},
									...
									{field: 'task', caption: 'Activity', width: '300', sortable: true, cls: 'text-center', hcls: ""},
									{field: 'result', caption: 'Description', width: '300', sortable: false, cls: 'text-center', hcls: ""},
									{field: 'detail', caption: '', width: '10', sortable: false, cls: 'text-center', hcls: ""},
									],
