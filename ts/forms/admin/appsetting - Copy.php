                        ...
                        $(function(){
                            table = $("#userlisttable").tablecontrol({
                                ...
                                colModel: [
									...
									{field: 'group', caption: 'Group', width: '100', sortable: false, cls: 'text-center', hcls: ""},
									{field: 'key', caption: 'Key', width: '', sortable: false, cls: 'text-left', hcls: "text-left"},
									{field: 'value', caption: 'Value', width: '120', sortable: false, cls: 'text-left', hcls: "text-left"}
