...
<h1><a href="projectlist.php" ><i class="icon-arrow-left-3 fg-darkRed"></i></a>
    Task Offered <small class="on-right">List</small>
</h1>
...
<table class="input-form" style="width: 60%;">
	...
	<tr>
		<th style="vertical-align: top;">Task Offered List</th>
		<td>				
			...
			<button class="button" type="button" id="addactivity" <?php if(($project['phactive']=='F')||((int)$project['phstatus']==3)) {echo "disabled";} ?>><i class="icon-plus on-left"></i>Add Task</button>			
			<script>
				$(function(){
				...
				function addActivity(obj){
					...
					var data = $('<tr><td class="text-left" style="width: 20px;"></td><td class="text-left" style="width: 100px;">'+activityname+'</td><td class="text-left" style="width: 40px;">'+activitydesc+'</td><td class="text-left" style="width: 100px;white-space:nowrap;">'+activitystart+'</td><td class="text-left" style="width: 100px;white-space:nowrap;">'+activityend+'</td><td class="text-left" style="width: 30px;"><a class="icon-arrow-up" onclick="moveRowUp(this); return false;"></a></td><td class="text-left" style="width: 30px;"><a class="icon-arrow-down" onclick="moveRowDown(this); return false;"></a></td><td class="text-left" style="width: 30px;"><a class="icon-cancel-2 icon-red" href="#" onclick="removeRow(this); return false;" ></a><input type="hidden" name="activityname[]" value="'+activityname+'" />><input type="hidden" name="activityid[]" value="new" /><input type="hidden" name="activitydesc[]" value="'+activitydesc+'" /><input type="hidden" name="activitystart[]" value="'+activitystart+'" /><input type="hidden" name="activityend[]" value="'+activityend+'" /></td></tr>');
