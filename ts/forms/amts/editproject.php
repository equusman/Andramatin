	...
	<tr>
		...
		<td colspan=2>
			<div class="input-control checkbox">
				<label>
					<input type="checkbox" name="published" <?php if($project['Published']=='1'){echo "checked";} ?> value="1" />
						...
						<?php
							if (is_array($phase)){
								...
								?> 
									...
									<?php	
										if (((int)$ph['STATUS']!=3) && ((int)hasTask($cek)==0)) {?>
									<a class="icon-cancel-2 icon-red" href="#" onclick="removeRow(this); return false;" >
									<?php }?>
									</a><input type="hidden" name="projectid[]" value="<?php echo $ph['ProjectID'];?>" /><input type="hidden" name="phaseid[]" value="<?php echo $ph['PhaseID'];?>" /><input type="hidden" name="phasename[]" value="<?php echo $ph['NAME'];?>" /><input type="hidden" name="phasedesc[]" value="<?php echo $ph['Description'];?>" />
									<input type="hidden" name="phasemd[]" value="<?php echo $ph['EstimatedManHour'];?>" /><input type="hidden" name="newphase[]" value="0" /></td></tr>
