...
function getMyOpenActivityAdmin($data){
	global $_db, $_config, $_user;
	...
	//get user id
	$currentuserid = isset($data['emp_id']) && !empty($data['emp_id'])? $data['emp_id'] :  $_user->getId();
	//die('>>>'.$currentuserid);
...
function getMyOpenActivityAdminTotal($data){
	global $_db, $_config, $_user ; 
