...
class Pagination {
	...
	public $text_first = '<span class="icon-first-2"></span>';
	public $text_last = '<span class="icon-last-2"></span>';
	public $text_next = '<span class="icon-arrow-right-4"></span>';
	public $text_prev = '<span class="icon-arrow-left-4"></span>';
